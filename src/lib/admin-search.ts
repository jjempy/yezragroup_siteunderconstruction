...
const SITE_SETTINGS_FIELDS: { key: keyof SiteSettings; page: string; pageLabel: string; fieldLabel: string }[] = [
  ...
  { key: 'color_gold', page: '/admin/brand', pageLabel: 'Brand', fieldLabel: 'Accent Color' },
  { key: 'color_gold_deep', page: '/admin/brand', pageLabel: 'Brand', fieldLabel: 'Accent Hover Color' },
  { key: 'color_ink', page: '/admin/brand', pageLabel: 'Brand', fieldLabel: 'Dark Background Color' },
  { key: 'color_cream', page: '/admin/brand', pageLabel: 'Brand', fieldLabel: 'Light Background Color' },
  ...
  { key: 'ladder_eyebrow', page: '/admin/content', pageLabel: 'Hero & About', fieldLabel: 'Offers Section Eyebrow' },
  { key: 'ladder_heading', page: '/admin/content', pageLabel: 'Hero & About', fieldLabel: 'Offers Section Heading' },
  { key: 'ladder_lede', page: '/admin/content', pageLabel: 'Hero & About', fieldLabel: 'Offers Section Subheading' },
